...
extension KeyboardShortcuts.Name {
    ...
    static let specialVision = KeyboardShortcuts.Name("specialVision", default: Shortcut(.i, modifiers: [.command, .option]))
    static let specialFocus = KeyboardShortcuts.Name("specialFocus", default: Shortcut(.f, modifiers: [.command, .option]))
